...
\begin{minipage}{12cm}
\begin{center}
\Large\textbf{Langage \'ecrit - Le mot \MakeUppercase{camille}}
\end{center}
\normalsize Nous avons d\'ecouvert puis appris \`a m\'emoriser le mot\\
\MakeUppercase{camille}\\
...
\large\noindent En capitale :
\begin{center}
{\huge \textbf{\MakeUppercase{camille}}}
\vspace{0.25cm}\\
\begin{tabulary}{17cm}{|g|g|g|g|g|}
\hline
camille & chapelle & mille & éveiller & voile \\
\hline
cuiller & entonner & village & limite & lancer \\
\hline
voeu & fille & camille & examiner & utilité \\
\hline
haillon & villa & oisillon & camille & sermon \\
\hline
minuit & volaille & facilité & atteler & camille \\
\hline
\end{tabulary}
\end{center}
\vspace{0.5cm}
